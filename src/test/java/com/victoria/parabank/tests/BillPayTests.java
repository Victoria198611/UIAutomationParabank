...
public class BillPayTests extends BaseTest {
    ...
    public void verifyBillPaymentIsSuccessful() {
        ...
        billPayPage.payBill("Electric Company", "123 Main St", "Los Angeles", "CA", "90001", "5551234567", "123456", "123456", "100");
        ...
        Assert.assertTrue(billPayPage.getConfirmationMessage().contains("Bill Payment Service"),
                "Bill Payment failed! Actual message: " + billPayPage.getConfirmationMessage());

        Assert.assertTrue(billPayPage.getConfirmationDetail().contains("successful"),
                "Bill Payment failed! Actual detail: " + billPayPage.getConfirmationDetail());
        Assert.assertFalse(billPayPage.getConfirmationMessage().isEmpty(), "Title not found!");
    }
    }
